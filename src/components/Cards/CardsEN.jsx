                ...
                <Grid item component = {Card} xs={12} md={3} className={cx(styles.card, styles.infected)}>
                    <CardContent>
                        ...
                        <img src="https://cdn1.iconfinder.com/data/icons/50-set-korona-virus/512/028-infected-512.png" alt="infected" ></img>
                           <h2 class="content contentEnglish">
                               INFECTED</h2> 
                                
                        </Typography>

                        <Typography class="content contentEnglish" variant="body2" gutterBottom>
                        ...
                        <Typography class="content contentEnglish" color="textSecondary" gutterBottom>
